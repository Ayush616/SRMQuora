...
if(array_key_exists("answer", $_POST)){
    ...
    if(!mysqli_query($connection, $query)){
            ...
            exit();
        $ansError = "Some Problem Occured. Please try again later.";
        }else{
        $ansSuccess="Your Answer has been posted successfully and now it is visible in portal";
        }
        
        }else{
        $ansError = "You have already answered for this question.";
    }
   ...
   <div class="container custom-container">
       ...
       <div class="collapse navbar-collapse" id="responsive">
           <ul class="navbar-nav mr-auto">
               ...
               <li class="nav-item" >
                   <a href="" data-toggle="modal" data-target="#myModal"class="btn btn-sm mt-2 text-white" style="background-color:purple"><i class="fas fa-plus"> Add Question</i></a>
               </li>
           </ul>
...
<div class="container p-3 my-3 border w-50" >
     ...
     <?php 
            if($queSuccess!=""){
                ...
                echo '<span class="alert alert-danger">'.$queAlert.'</span>'; }?>
            ...
            <!---Alerts for answer---->
             ...
             <?php    
                ...
                echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                  <strong>Congratulation '.$firstname.'!</strong><br>'.$ansSuccess.' 
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>' ;}
                ...
                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                  <strong>Hey '.$firstname.'!</strong><br>'.$ansError.' 
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>' ;}
  ...
  <!---------------------------------------------------------------------------------------------------------------------->
        ...
        <!-------------------------------- Answer--------------------------------------------------->
                    ...
                    <p style="margin-top: 15px;">
                        <?php 
                            ...
                            while($i<count(get_answer($qid, $connection))) {
                                ...
                                <small>".get_designation($userid[$i], $connection)."</small></h6>
                    ...
                    <span class="lead">Do you want to answer? Click this icon</span>
                                    <span data-toggle="modal" data-target="#ans<?php echo $qid?>" class="" onclick="">
            ...
            <!--------------------------------------------------------------------------------------------------------------------                    <!-------------------------------------------------------------------------------------------------------------------->                 
                         ...
                         <!-- The Answer Modal -->
                <div class="modal" id="ans<?php echo $qid?>">
                  <div class="modal-dialog">
                    <div class="modal-content">
                            <form action="" method="post">
                      <!-- Modal Header -->
...
<!--------------------------------------------------------------------------------------------------------------------> 
                    ...
                    <?php }else{
                        echo '<hr>';
                        echo '
                            <div data-toggle="modal" data-target="#ans'.$qid.'">
                                    <div class="btn">
